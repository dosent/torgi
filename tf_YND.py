...
def prepare_data(data_file_name):
    ...
    df.replace('.000000', 0, inplace=True)
    df.replace('.100000', 1, inplace=True)
    df.replace('.200000', 2, inplace=True)
    df.replace('.300000', 3, inplace=True)
    df.replace('.400000', 4, inplace=True)
    df.replace('.500000', 5, inplace=True)
    df.replace('.600000', 6, inplace=True)
    df.replace('.700000', 7, inplace=True)
    df.replace('.800000', 8, inplace=True)
    df.replace('.900000', 9, inplace=True)
