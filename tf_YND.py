...
def prepare_data(data_file_name):
    ...
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.000000', 0, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.100000', 1, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.200000', 2, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.300000', 3, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.400000', 4, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.500000', 5, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.600000', 6, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.700000', 7, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.800000', 8, inplace=True)
    df['<OPEN>','<HIGH>','<LOW>','<CLOSE>'].replace('.900000', 9, inplace=True)
